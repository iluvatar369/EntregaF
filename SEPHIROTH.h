...
//Constructor 1
SEPHIROTH::SEPHIROTH(string _Game, int _DamagePer, int _TiltAttack, int _Turn, string _NameS, bool _LimitBreakS, int _SmashS):CHARACTER(_Game, _DamagePer, _TiltAttack, _Turn){
    NameS=_NameS;
    LimitBreakS=_LimitBreakS;
    SmashS=_SmashS;
}

SEPHIROTH::SEPHIROTH(string _Game, string information):CHARACTER(_Game){
    info=information;
}
